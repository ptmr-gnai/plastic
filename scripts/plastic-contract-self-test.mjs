export const assertSelfTestSurface = ({ assert, selfTest }) => {
  ...
  assert(typeof auditCheck.details.usable === "boolean" && typeof auditCheck.details.strictElectron === "string" && typeof auditCheck.details.unified === "string", "plastic/selfTest audit status missing runtime-unification verdict");
  ...
  assert(auditCheck.details.methodParity.reportPath === null || typeof auditCheck.details.methodParity.reportPath === "string", "plastic/selfTest audit status invalid method parity report path");
  ...
  assert(typeof orientationCheck.details.auditMetadata?.inProgress === "boolean" && typeof orientationCheck.details.auditMetadata.usable === "boolean", "plastic/selfTest workbench audit metadata missing progress/usability flags");
  assert(typeof orientationCheck.details.auditMetadata.strictElectron === "string" && typeof orientationCheck.details.auditMetadata.unified === "string", "plastic/selfTest workbench audit metadata missing runtime-unification verdict");
  ...
  assert(typeof orientationCheck.details.orientationAuditMetadata?.inProgress === "boolean" && typeof orientationCheck.details.orientationAuditMetadata.usable === "boolean", "plastic/selfTest orient audit metadata missing progress/usability flags");
  assert(typeof orientationCheck.details.orientationAuditMetadata.strictElectron === "string" && typeof orientationCheck.details.orientationAuditMetadata.unified === "string", "plastic/selfTest orient audit metadata missing runtime-unification verdict");
