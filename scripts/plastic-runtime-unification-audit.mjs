    ...
    child.on("exit", (code, signal) => {
      ...
      if (!result.ok) {
        result.diagnostics = {
          tail: output,
          hints: output
            .filter((line) => /plastic:entry|entry-cjs|entry-preflight|electronStartupHint|electron-main-ready|electron-launch|electron-child-status|electron-child-lsof|vite-ready|did not become ready|lsof -nP -iTCP:7331|lsof -nP -iTCP:7332|activeHostPid|activeHostExit/.test(line))
            .slice(-20)
        };
      }
