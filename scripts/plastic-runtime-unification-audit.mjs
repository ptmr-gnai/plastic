    ...
    child.on("exit", (code, signal) => {
      ...
      if (!result.ok) {
        result.diagnostics = {
          tail: output,
          hints: output
            .filter((line) => /plastic:entry|entry-preflight|electronStartupHint|electron-main-ready|electron-launch|vite-ready|did not become ready|lsof -nP -iTCP:7331|lsof -nP -iTCP:7332|activeHostPid|activeHostExit/.test(line))
            .slice(-20)
        };
      }
