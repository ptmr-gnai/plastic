export const assertChatMethodDescriptions = ({ assert, descriptions }) => {
  ...
  assert(descriptions.create.effects?.mutatesProjection?.includes("panels"), "chats/createCodexChat must describe panels projection mutation");
  assert(descriptions.create.effects?.mutatesProjection?.includes("windows"), "chats/createCodexChat must describe windows projection mutation");
