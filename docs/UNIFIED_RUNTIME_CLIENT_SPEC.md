...
4. `pnpm plastic:validate-unified` fails if any method catalog item lacks description, input schema, output schema, effects, reversibility, or method affordance links.
