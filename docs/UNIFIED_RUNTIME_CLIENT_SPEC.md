...
4. `node scripts/plastic-electron-launch-probe.mjs` prints a bounded JSON launch-target report that agents can run before heavier Electron diagnostics.
