...
- The shared contract harness cleans up generated extension/panel fixtures and tags raw, panel lifecycle, and extension scaffold validation events with `validation:contract`.
