...
4. `PLASTIC_ELECTRON_LAUNCH_PROBE_RUN=1 node scripts/plastic-electron-launch-probe.mjs` prints bounded launch-target, child command-line, launcher/profile, and entry-marker diagnostics; validation events stay durable, inspectable, and identifiable as validation scope.
